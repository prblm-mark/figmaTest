  ...
  'https://www.figma.com/design/Lus07xi8pPXLN87sQIyrEt/Affino-AI---Design-System?node-id=3039-5639',
  {
    props: {
      ...
      type: figma.enum('Type', {
        ...
        'Predictive Text': 'consolidated → Predictive Text Options (type-to-reveal)',
        'Predictive Text Options': 'text Input + type-to-reveal single-select menu',
        'Predictive text OPtions w/subtext': 'same + subtext rows',
        'Multi Select Table': 'Datatables + FilterItem chips + Apply (640px)',
        'Multi Select Modal': 'Modal + Datatables + FilterItem chips + Cancel/Apply (960px)',
      }),
    },
    example: ({ type }) => html`
