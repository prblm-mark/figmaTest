...
| `seating-deferred-controls` | All remaining `[data-sp-action]` controls | Render + announce their owning task. **new-plan and plan-edit are now built** and prove the pattern | One sub-task each: copy-plans 344756 · plan-delete 344755 · add-table 344757 · room-layout 344760 · export 344761 · table-edit 342307 · table-delete 344758 · assign-seat 342309 | needs-backend |
