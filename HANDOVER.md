...
| `seating-deferred-controls` | All remaining `[data-sp-action]` controls | Render + announce their owning task. **new-plan, plan-edit, plan-delete and copy-plans are now built** | One sub-task each: add-table 344757 · room-layout 344760 · export 344761 · table-edit 342307 · table-delete 344758 · assign-seat 342309 | needs-backend |
