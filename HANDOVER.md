...
| `seating-deferred-controls` | All remaining `[data-sp-action]` controls | Render + announce their owning task. **Built so far: new-plan, plan-edit, plan-delete, copy-plans, add-table, table-edit, table-delete** | One sub-task each: room-layout 344760 · export 344761 · assign-seat 342309 | needs-backend |
